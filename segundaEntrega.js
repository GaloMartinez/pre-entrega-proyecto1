...
let cascosAdicionales = resultadoFiltro.length * valorCasco;		
let valorTotal = (corredoresDisponibles * valor) + cascosAdicionales;
alert("Son " + corredoresDisponibles + " corredores disponibles, " + resultadoFiltro.length + " cascos adicionales,  el valor total es : " +valorTotal);
